...
const paragraphs = [
    { text: "Join our Diploma in Cyber Security Program to Become a Professional Cyber Expert", color: "orange"},
    { text: "Learn Advanced Black-Hat Hacking to Join Indian Cyber Army", color: "white"},
    { text: "Build a powerfull resume with our Cyber Security Internship Program, to get a Job in IT Company", color: "lime"},
];
